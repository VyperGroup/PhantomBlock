...
1. the [aero sandboxing library](https://github.com/VyperGroup/aero/blob/Unstable/src/AeroSandbox/DEV.md#how-to-use-with-faker) - This is just the compiled script for the aero sandboxing library with the SW-less runtime for proxies enabled, the [Faker API enabled](https://github.com/VyperGroup/aero/blob/Unstable/src/AeroSandbox/index.d.ts#L21), and the [redirectors disabled](https://github.com/VyperGroup/aero/blob/Unstable/src/AeroSandbox/index.d.ts#L40).
2. The [fake SW script](https://github.com/VyperGroup/SW-less/blob/main/README.md) containing all the generated code that emulates the network blocking urls
3. "freezers" AND
...
I will make polyfills for the removed [MV2](https://developer.chrome.com/docs/extensions/mv2/) [APIs](https://developer.chrome.com/docs/extensions/mv2/reference). Any functionality removed will be emulated with a content script with aero's sandboxing library.
